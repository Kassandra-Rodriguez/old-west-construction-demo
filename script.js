/* ═══════════════════════════════════════════════════════
   Old West El Paso Construction — concept site behaviour
   ═══════════════════════════════════════════════════════ */
(function () {
  'use strict';
  ...
  /* ─── Financing assumptions ───────────────────────────
     ...
     Old West's lender / finance partner before this goes live.
     ─────────────────────────────────────────────────── */
  var APR = 0.0999;           // 9.99% annual percentage rate
  // terms offered live in the markup (36 / 60 / 84 months)
  ...
  var saved = null;
  try { saved = localStorage.getItem('ow-lang'); } catch (e) {}
  ...
  function renderCalc() {
    ...
    amount.style.background =
      'linear-gradient(90deg, var(--rust) ' + pct + '%, rgba(255,255,255,.2) ' + pct + '%)';
  }
